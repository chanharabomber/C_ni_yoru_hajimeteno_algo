 ...
 *
 *  @version $Revision: 1.13 $, $Date: 2003/03/21 14:40:34 $
 */

import java.awt.*;
import java.awt.event.*;

public class Chaossss extends DrawOneByOnePanel {
    static final int WIDTH = 640,  HEIGHT = 400;
    private double kMin, kMax, pMin, pMax;

    public Chaossss(double kMin, double kMax, double pMin, double pMax) {
    ...
    public static void main(String[] args) {
        DrawOneByOnePanel p = new Chaossss(1.5, 3, 0, 1.5);
