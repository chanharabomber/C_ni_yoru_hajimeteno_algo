...
public class HashChain {
     ...
     * ハッシュコード
     * @param key キー
     * @return 与えられたキーのハッシュコードをハッシュ表のサイズで割った余りを返す
     */
     ...
     * 検索
     * @param key キー
     * @return キーに対応するデータ（登録されていない場合は null）
     */
     ...
     * @param key キー
     * @param data データ
     * @return true：成功・false：既に同じキーが登録されている場合
     */
     ...
     * 削除
     * @param key キー
     * @return  true：成功・false：キーが登録されていない場合
     */
